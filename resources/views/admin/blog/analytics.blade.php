...
@endsection
@push('scripts')<script nonce="{{ $cspNonce ?? '' }}">document.querySelector('[data-period-select]')?.addEventListener('change',function(){document.querySelectorAll('[data-custom-period]').forEach(element=>element.classList.toggle('d-none',this.value!=='custom'));});</script>@endpush
