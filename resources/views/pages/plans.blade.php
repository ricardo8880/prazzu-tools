    ...
    <div class="prazzu-page">
        <section class="text-center mb-5" aria-labelledby="plans-title">
            ...
            <div class="d-inline-flex flex-wrap justify-content-center gap-2" aria-label="Destaques do Prazzu Plus">
                <span class="badge rounded-pill border text-body-emphasis px-3 py-2">
                    <i class="bi bi-infinity me-1 text-primary" aria-hidden="true"></i>Uso ilimitado
                </span>
                <span class="badge rounded-pill border text-body-emphasis px-3 py-2">
                    <i class="bi bi-grid-3x3-gap me-1 text-primary" aria-hidden="true"></i>Todas as ferramentas
                </span>
                <span class="badge rounded-pill border text-body-emphasis px-3 py-2">
                    <i class="bi bi-stars me-1 text-primary" aria-hidden="true"></i>Novos recursos incluídos
                </span>
            </div>
        </section>
        ...
        <section class="mb-5" aria-labelledby="billing-heading">
            ...
            <div class="d-flex justify-content-center mb-4">
                <div class="nav nav-pills bg-body-tertiary border rounded-pill p-1" id="billing-options" role="tablist" aria-label="Período da assinatura">
                    ...
                    <button class="nav-link rounded-pill" id="billing-quarterly-tab" data-bs-toggle="pill" data-bs-target="#billing-quarterly" type="button" role="tab" aria-controls="billing-quarterly" aria-selected="false">
                        Trimestral
                        <span class="badge text-bg-success ms-1">Economize</span>
                    </button>
                    <button class="nav-link rounded-pill" id="billing-annual-tab" data-bs-toggle="pill" data-bs-target="#billing-annual" type="button" role="tab" aria-controls="billing-annual" aria-selected="false">
                        Anual
                        <span class="badge text-bg-success ms-1">Melhor valor</span>
                    </button>
                </div>
            </div>
            ...
            <div class="row g-4 justify-content-center align-items-stretch">
                    ...
                    <article class="card h-100 border-secondary-subtle shadow-sm">
                        <div class="card-body p-4 p-lg-5 d-flex flex-column">
                            <div class="d-flex justify-content-between align-items-start gap-3 mb-4">
                                <div>
                                    <span class="badge text-bg-secondary mb-3">Gratuito</span>
                                ...
                                <i class="bi bi-shield-check fs-2 text-success" aria-hidden="true"></i>
                            </div>
                ...
                <div class="col-12 col-xl-7">
                    <article class="card h-100 border-primary shadow position-relative overflow-hidden">
                        <div class="card-header bg-primary text-white border-0 p-3 text-center">
                        ...
                        <div class="card-body p-4 p-lg-5 d-flex flex-column">
                            <div class="d-flex justify-content-between align-items-start gap-3 mb-4">
                                <div>
                                    <span class="badge text-bg-primary mb-3">Prazzu Plus</span>
                                ...
                                <i class="bi bi-gem fs-2 text-primary" aria-hidden="true"></i>
                            </div>
                            ...
                            <div class="tab-content mb-4" id="billing-content">
                                ...
                                <div class="tab-pane fade" id="billing-quarterly" role="tabpanel" aria-labelledby="billing-quarterly-tab" tabindex="0">
                                    ...
                                    <p class="text-success mb-0"><i class="bi bi-piggy-bank me-1" aria-hidden="true"></i>Economia de R$ 9,80 por trimestre.</p>
                                </div>
                                ...
                                <div class="tab-pane fade" id="billing-annual" role="tabpanel" aria-labelledby="billing-annual-tab" tabindex="0">
                                    ...
                                    <p class="text-success mb-0"><i class="bi bi-piggy-bank me-1" aria-hidden="true"></i>Economia de R$ 78,90 por ano.</p>
                                </div>
                            </div>

                            <ul class="list-unstyled row g-3 mb-4">
                                <li class="col-12 col-md-6 d-flex gap-2"><i class="bi bi-check-circle-fill text-success flex-shrink-0" aria-hidden="true"></i><span>Recursos Plus ilimitados</span></li>
                                <li class="col-12 col-md-6 d-flex gap-2"><i class="bi bi-check-circle-fill text-success flex-shrink-0" aria-hidden="true"></i><span>Históricos e salvamentos</span></li>
                                <li class="col-12 col-md-6 d-flex gap-2"><i class="bi bi-check-circle-fill text-success flex-shrink-0" aria-hidden="true"></i><span>Simulações e comparações</span></li>
                                <li class="col-12 col-md-6 d-flex gap-2"><i class="bi bi-check-circle-fill text-success flex-shrink-0" aria-hidden="true"></i><span>Projeções e alertas</span></li>
                                <li class="col-12 col-md-6 d-flex gap-2"><i class="bi bi-check-circle-fill text-success flex-shrink-0" aria-hidden="true"></i><span>Automações e produtividade</span></li>
                                <li class="col-12 col-md-6 d-flex gap-2"><i class="bi bi-check-circle-fill text-success flex-shrink-0" aria-hidden="true"></i><span>Novas ferramentas incluídas</span></li>
                            </ul>

                            <button class="btn btn-primary btn-lg w-100 mt-auto" type="button" disabled>
        ...
        <section class="mb-5" aria-labelledby="faq-heading">
            ...
            <div class="accordion mx-auto" id="plans-faq" style="max-width: 900px;">
        ...
        <section class="card border-primary shadow-sm overflow-hidden" aria-labelledby="plans-cta-heading">
