# Convite empresarial — Prazzu Tools

- **Tipo:** Página de organização
- **Implementação principal:** `resources/views/organizations/invitations/show.blade.php`
- **Status:** ativa no código atual

## Objetivo

Apresentar e permitir a utilização da área **Convite empresarial — Prazzu Tools** dentro da plataforma.
...
- conteúdo dinâmico convidou você
