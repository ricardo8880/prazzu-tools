# Cadastrar empresa — Prazzu Tools

- **Tipo:** Página de organização
- **Implementação principal:** `resources/views/organizations/create.blade.php`
- **Status:** ativa no código atual

## Objetivo

Apresentar e permitir a utilização da área **Cadastrar empresa — Prazzu Tools** dentro da plataforma.
