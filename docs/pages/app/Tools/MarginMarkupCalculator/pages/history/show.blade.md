# Detalhes de Margem e Markup — Prazzu Tools

- **Tipo:** Página de histórico
- **Implementação principal:** `app/Tools/MarginMarkupCalculator/Resources/views/history/show.blade.php`
- **Status:** ativa no código atual

## Objetivo

Apresentar ou detalhar registros anteriores relacionados a **Detalhes de Margem e Markup — Prazzu Tools**.
