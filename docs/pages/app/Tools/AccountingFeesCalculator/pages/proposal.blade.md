# Proposta Comercial de Serviços Contábeis — Prazzu Tools

- **Tipo:** Página de ferramenta
- **Implementação principal:** `app/Tools/AccountingFeesCalculator/Resources/views/proposal.blade.php`
- **Status:** ativa no código atual

## Objetivo

Oferecer a interface e o fluxo funcional de **Proposta Comercial de Serviços Contábeis — Prazzu Tools**, respeitando as regras de domínio do módulo ao qual pertence.
