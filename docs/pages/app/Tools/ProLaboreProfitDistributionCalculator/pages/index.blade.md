# Calculadora de Pró-Labore e Distribuição de Lucros — Prazzu Tools

- **Tipo:** Página de ferramenta
- **Implementação principal:** `app/Tools/ProLaboreProfitDistributionCalculator/Resources/views/index.blade.php`
- **Status:** ativa no código atual

## Objetivo

Oferecer a interface e o fluxo funcional de **Calculadora de Pró-Labore e Distribuição de Lucros — Prazzu Tools**, respeitando as regras de domínio do módulo ao qual pertence.
