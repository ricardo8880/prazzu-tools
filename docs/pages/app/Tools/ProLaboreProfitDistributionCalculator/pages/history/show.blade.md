# Simulação salva — Pró-Labore e Lucros

- **Tipo:** Página de histórico
- **Implementação principal:** `app/Tools/ProLaboreProfitDistributionCalculator/Resources/views/history/show.blade.php`
- **Status:** ativa no código atual

## Objetivo

Apresentar ou detalhar registros anteriores relacionados a **Simulação salva — Pró-Labore e Lucros**.
