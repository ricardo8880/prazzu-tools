# Histórico de DARF/GPS

- **Tipo:** Página de histórico
- **Implementação principal:** `app/Tools/FederalPaymentGuideGenerator/Resources/views/history/index.blade.php`
- **Status:** ativa no código atual

## Objetivo

Apresentar ou detalhar registros anteriores relacionados a **Histórico de DARF/GPS**.
