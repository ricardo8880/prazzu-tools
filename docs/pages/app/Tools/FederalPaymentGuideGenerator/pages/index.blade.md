# Gerador Inteligente de DARF/GPS — Prazzu Tools

- **Tipo:** Página de ferramenta
- **Implementação principal:** `app/Tools/FederalPaymentGuideGenerator/Resources/views/index.blade.php`
- **Status:** ativa no código atual

## Objetivo

Oferecer a interface e o fluxo funcional de **Gerador Inteligente de DARF/GPS — Prazzu Tools**, respeitando as regras de domínio do módulo ao qual pertence.
