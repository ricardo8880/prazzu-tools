# Histórico — Comparador Tributário

- **Tipo:** Página de histórico
- **Implementação principal:** `app/Tools/TaxRegimeComparator/Resources/views/history/index.blade.php`
- **Status:** ativa no código atual

## Objetivo

Apresentar ou detalhar registros anteriores relacionados a **Histórico — Comparador Tributário**.
