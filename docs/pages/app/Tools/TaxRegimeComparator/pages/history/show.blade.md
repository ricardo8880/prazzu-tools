# Comparação salva — Comparador Tributário

- **Tipo:** Página de histórico
- **Implementação principal:** `app/Tools/TaxRegimeComparator/Resources/views/history/show.blade.php`
- **Status:** ativa no código atual

## Objetivo

Apresentar ou detalhar registros anteriores relacionados a **Comparação salva — Comparador Tributário**.
