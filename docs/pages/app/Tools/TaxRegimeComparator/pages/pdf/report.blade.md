...
- **Implementação principal:** `app/Tools/TaxRegimeComparator/Resources/views/pdf/report.blade.php`
- **Status:** ativa no código atual

## Objetivo

Gerar uma representação adequada para impressão, exportação ou PDF de **Resumo**.
