# Comparador Tributário — Prazzu Tools

- **Tipo:** Página de ferramenta
- **Implementação principal:** `app/Tools/TaxRegimeComparator/Resources/views/index.blade.php`
- **Status:** ativa no código atual

## Objetivo

Oferecer a interface e o fluxo funcional de **Comparador Tributário — Prazzu Tools**, respeitando as regras de domínio do módulo ao qual pertence.

## Como funciona

A página é renderizada pela view Blade indicada acima e utiliza o layout, os componentes compartilhados e os dados fornecidos pelo controller ou fluxo responsável. A implementação atual contém 3 formulário(s), 1 tabela(s).

## Estrutura e conteúdos identificados

- Dados do cenário
- Dados avançados para maior cobertura
- Resultado da comparação
- conteúdo dinâmico
- Regimes não comparáveis neste cenário
