# Histórico do Conversor Fiscal de XML

- **Tipo:** Página de histórico
- **Implementação principal:** `app/Tools/FiscalXmlConverter/Resources/views/history/index.blade.php`
- **Status:** ativa no código atual

## Objetivo

Apresentar ou detalhar registros anteriores relacionados a **Histórico do Conversor Fiscal de XML**.
