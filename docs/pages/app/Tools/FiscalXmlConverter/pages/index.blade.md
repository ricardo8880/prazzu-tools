# Conversor Fiscal de XML — Prazzu Tools

- **Tipo:** Página de ferramenta
- **Implementação principal:** `app/Tools/FiscalXmlConverter/Resources/views/index.blade.php`
- **Status:** ativa no código atual

## Objetivo

Oferecer a interface e o fluxo funcional de **Conversor Fiscal de XML — Prazzu Tools**, respeitando as regras de domínio do módulo ao qual pertence.
