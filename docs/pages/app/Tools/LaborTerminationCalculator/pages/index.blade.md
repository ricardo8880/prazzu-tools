# Calculadora de Rescisão Trabalhista — Prazzu Tools

- **Tipo:** Página de ferramenta
- **Implementação principal:** `app/Tools/LaborTerminationCalculator/Resources/views/index.blade.php`
- **Status:** ativa no código atual

## Objetivo

Oferecer a interface e o fluxo funcional de **Calculadora de Rescisão Trabalhista — Prazzu Tools**, respeitando as regras de domínio do módulo ao qual pertence.

## Como funciona

A página é renderizada pela view Blade indicada acima e utiliza o layout, os componentes compartilhados e os dados fornecidos pelo controller ou fluxo responsável. A implementação atual contém 2 formulário(s), 2 tabela(s).

## Estrutura e conteúdos identificados

- Histórico recente
- Dados da rescisão
- Casos especiais e remuneração variável
- FGTS e descontos
- Resultado da rescisão
- O que a ferramenta calculará
