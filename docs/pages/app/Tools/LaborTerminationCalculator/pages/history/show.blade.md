# Detalhes do cálculo de rescisão — Prazzu Tools

- **Tipo:** Página de histórico
- **Implementação principal:** `app/Tools/LaborTerminationCalculator/Resources/views/history/show.blade.php`
- **Status:** ativa no código atual

## Objetivo

Apresentar ou detalhar registros anteriores relacionados a **Detalhes do cálculo de rescisão — Prazzu Tools**.
