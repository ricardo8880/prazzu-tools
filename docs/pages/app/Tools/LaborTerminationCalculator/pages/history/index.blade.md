# Histórico de Rescisões — Prazzu Tools

- **Tipo:** Página de histórico
- **Implementação principal:** `app/Tools/LaborTerminationCalculator/Resources/views/history/index.blade.php`
- **Status:** ativa no código atual

## Objetivo

Apresentar ou detalhar registros anteriores relacionados a **Histórico de Rescisões — Prazzu Tools**.
