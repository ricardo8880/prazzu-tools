# Sugerir ferramenta — Prazzu Tools

- **Tipo:** Página da plataforma
- **Implementação principal:** `resources/views/pages/suggest-tool.blade.php`
- **Status:** ativa no código atual

## Objetivo

Apresentar e permitir a utilização da área **Sugerir ferramenta — Prazzu Tools** dentro da plataforma.
