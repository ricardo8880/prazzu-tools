...
- **Implementação principal:** `resources/views/exports/browser-print.blade.php`
- **Status:** ativa no código atual

## Objetivo

Gerar uma representação adequada para impressão, exportação ou PDF de **conteúdo dinâmico**.
