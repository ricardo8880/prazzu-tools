# Jornadas de aquisição | Prazzu Tools

- **Tipo:** Página administrativa
- **Implementação principal:** `resources/views/admin/acquisition/index.blade.php`
- **Status:** ativa no código atual

## Objetivo

Permitir que usuários autorizados executem e acompanhem as operações administrativas relacionadas a **Jornadas de aquisição | Prazzu Tools**.
