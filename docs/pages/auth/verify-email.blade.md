# Confirmar e-mail — Prazzu Tools

- **Tipo:** Página de autenticação
- **Implementação principal:** `resources/views/auth/verify-email.blade.php`
- **Status:** ativa no código atual

## Objetivo

Conduzir o usuário com segurança pelo fluxo de **Confirmar e-mail — Prazzu Tools**.
