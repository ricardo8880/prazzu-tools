# Criar nova senha — Prazzu Tools

- **Tipo:** Página de autenticação
- **Implementação principal:** `resources/views/auth/reset-password.blade.php`
- **Status:** ativa no código atual

## Objetivo

Conduzir o usuário com segurança pelo fluxo de **Criar nova senha — Prazzu Tools**.
