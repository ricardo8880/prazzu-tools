# Recuperar senha — Prazzu Tools

- **Tipo:** Página de autenticação
- **Implementação principal:** `resources/views/auth/forgot-password.blade.php`
- **Status:** ativa no código atual

## Objetivo

Conduzir o usuário com segurança pelo fluxo de **Recuperar senha — Prazzu Tools**.
