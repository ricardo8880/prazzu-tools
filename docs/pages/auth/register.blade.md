# Criar conta — Prazzu Tools

- **Tipo:** Página de autenticação
- **Implementação principal:** `resources/views/auth/register.blade.php`
- **Status:** ativa no código atual

## Objetivo

Conduzir o usuário com segurança pelo fluxo de **Criar conta — Prazzu Tools**.
...
- Crie sua conta para salvar resultados
