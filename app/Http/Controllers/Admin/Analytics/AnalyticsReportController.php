...
final class AnalyticsReportController extends Controller
{
    ...
    public function export(AnalyticsReportRequest $request, AnalyticsReportQuery $query, AnalyticsReportFileBuilder $files): Response|StreamedResponse
    {
