...
final class AnalyticsEventCatalog
{
    ...
    private const DEFINITIONS = [
        ...
        'home.search.submitted' => ['label' => 'Busca enviada na página inicial', 'category' => 'Demanda', 'description' => 'Um visitante enviou um termo pelo campo de busca da página inicial.', 'business_meaning' => 'Revela o que os visitantes procuram e destaca oportunidades de novas ferramentas quando não há resultados.'],
        'discovery.problem-journey.opened' => ['label' => 'Jornada por problema iniciada', 'category' => 'Descoberta', 'description' => 'Uma ferramenta foi aberta a partir de uma jornada orientada ao problema na Home ou no catálogo.', 'business_meaning' => 'Mede se organizar o catálogo por rotinas ajuda o visitante a encontrar um ponto de entrada útil sem conhecer o nome da ferramenta.'],
        'acquisition.context.entered' => ['label' => 'Contexto de aquisição ativado', 'category' => 'Aquisição', 'description' => 'Um contexto de aquisição válido foi ativado a partir de um link.', 'business_meaning' => 'Mede quantas entradas realmente iniciaram uma experiência contextual.'],
        'acquisition.context.exited' => ['label' => 'Contexto de aquisição encerrado', 'category' => 'Aquisição', 'description' => 'O visitante encerrou voluntariamente a experiência contextual.', 'business_meaning' => 'Mede quantas pessoas preferiram voltar à exploração livre da plataforma.'],
        'acquisition.context.continued' => ['label' => 'Continuação contextual escolhida', 'category' => 'Aquisição', 'description' => 'O visitante escolheu seguir para a ação principal sugerida pelo contexto.', 'business_meaning' => 'Mede aceitação da experiência personalizada e intenção de avançar no tema.'],
        'acquisition.context.resolved' => ['label' => 'Contexto de aquisição resolvido', 'category' => 'Aquisição', 'description' => 'A experiência contextual foi carregada e ficou disponível para coleta no navegador.', 'business_meaning' => 'Mede carregamentos válidos da experiência de campanha.'],
        'acquisition.hero.viewed' => ['label' => 'Hero contextual visualizado', 'category' => 'Aquisição', 'description' => 'O hero da experiência contextual entrou na área visível.', 'business_meaning' => 'Mede exposição real à principal mensagem da campanha.'],
        'acquisition.cta.viewed' => ['label' => 'CTA contextual visualizado', 'category' => 'Aquisição', 'description' => 'A chamada para ação contextual entrou na área visível.', 'business_meaning' => 'Mede exposição real à ação sugerida pela campanha.'],
        'acquisition.cta.clicked' => ['label' => 'CTA contextual clicado', 'category' => 'Aquisição', 'description' => 'O visitante clicou na chamada para ação contextual.', 'business_meaning' => 'Mede intenção de avançar pela ação principal da campanha.'],
        'acquisition.tool.impression' => ['label' => 'Ferramenta contextual visualizada', 'category' => 'Aquisição', 'description' => 'Uma ferramenta recomendada pelo contexto entrou na área visível.', 'business_meaning' => 'Mede descoberta das ferramentas promovidas pela campanha.'],
        'acquisition.tool.clicked' => ['label' => 'Ferramenta contextual clicada', 'category' => 'Aquisição', 'description' => 'O visitante abriu uma ferramenta recomendada pelo contexto.', 'business_meaning' => 'Mede a capacidade da campanha de gerar uso de ferramentas.'],
        ...
        'tool.started' => ['label' => 'Jornada da ferramenta iniciada', 'category' => 'Ferramentas', 'description' => 'O visitante começou a interagir com o formulário principal da ferramenta.', 'business_meaning' => 'Marca o início real do funil de utilização.'],
        'tool.step.changed' => ['label' => 'Etapa da ferramenta alterada', 'category' => 'Ferramentas', 'description' => 'O visitante avançou ou retornou entre etapas declaradas da jornada.', 'business_meaning' => 'Localiza progressão e abandono por etapa.'],
        'tool.field.completed' => ['label' => 'Campo da ferramenta concluído', 'category' => 'Ferramentas', 'description' => 'Um campo declarado foi preenchido de forma válida, sem registrar seu conteúdo.', 'business_meaning' => 'Identifica avanço e campos que antecedem desistências.'],
        'tool.validation.error' => ['label' => 'Erro de validação da ferramenta', 'category' => 'Ferramentas', 'description' => 'Uma regra de validação impediu o avanço ou a execução.', 'business_meaning' => 'Revela campos e regras que causam dificuldade recorrente.'],
        'tool.calculation.executed' => ['label' => 'Cálculo executado', 'category' => 'Ferramentas', 'description' => 'A ação principal foi enviada para processamento, com sucesso ou falha declarados em metadados.', 'business_meaning' => 'Mede tentativas de obtenção do resultado e desempenho da execução.'],
        'tool.result.viewed' => ['label' => 'Resultado visualizado', 'category' => 'Ferramentas', 'description' => 'O resultado principal entrou na área visível do visitante.', 'business_meaning' => 'Confirma que o valor produzido chegou efetivamente ao utilizador.'],
        'tool.shared' => ['label' => 'Conteúdo da ferramenta partilhado', 'category' => 'Ferramentas', 'description' => 'O visitante utilizou uma ação de partilha da ferramenta.', 'business_meaning' => 'Indica utilidade percebida e potencial de recomendação.'],
        'tool.abandoned' => ['label' => 'Jornada da ferramenta abandonada', 'category' => 'Ferramentas', 'description' => 'A sessão terminou antes do critério declarado de conclusão.', 'business_meaning' => 'Localiza a etapa, o campo e o tempo associados à desistência.'],
        ...
        'tool.resolution.submitted' => ['label' => 'Resolução avaliada', 'category' => 'Satisfação', 'description' => 'Após receber um resultado, o visitante informou se a ferramenta resolveu sua necessidade.', 'business_meaning' => 'Mede valor percebido além da simples geração do resultado e revela motivos de resolução parcial ou negativa.'],
        ...
        'newsletter.subscribed' => ['label' => 'Inscrição na newsletter', 'category' => 'Retenção', 'description' => 'Um visitante confirmou o recebimento de atualizações da plataforma.', 'business_meaning' => 'Mede a criação de um canal voluntário para retorno após a primeira visita.'],
        'retention.continuity.used' => ['label' => 'Atalho de continuidade usado', 'category' => 'Retenção', 'description' => 'Um visitante ou usuário reabriu uma ferramenta por uma superfície de continuidade do Prazzu.', 'business_meaning' => 'Mede se Home, Meu Prazzu, favoritos e histórico realmente ajudam alguém a voltar ao produto.'],
        'retention.related-tool.opened' => ['label' => 'Ferramenta relacionada aberta', 'category' => 'Retenção', 'description' => 'Uma ferramenta foi aberta a partir da jornada editorial de outra ferramenta.', 'business_meaning' => 'Mede se as recomendações conduzem a uma segunda necessidade real em vez de apenas ocupar espaço na página.'],
