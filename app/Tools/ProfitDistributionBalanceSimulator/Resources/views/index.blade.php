    ...
    <form data-testid="tool-form-panel" method="post" action="{{ route('tools.simulador-distribuicao-lucros-balanco.calculate') }}" class="d-grid gap-4" data-analytics-form="main">
        ...
        <x-tools.form-panel title="Escrituração e planejamento" description="Plus — simule a formação do lucro contábil, pró-labore, despesas, distribuições acumuladas e planejamento de até 24 meses.">
            <div class="row g-3">
                ...
                <div class="col-md-4"><label class="form-label">Despesas operacionais anuais</label><div class="input-group"><span class="input-group-text">R$</span><input class="form-control" name="operating_expenses" value="{{ old('operating_expenses') }}" placeholder="Ex.: 66.000,00"></div></div>
                <div class="col-md-4"><label class="form-label">Outras despesas anuais</label><div class="input-group"><span class="input-group-text">R$</span><input class="form-control" name="other_expenses" value="{{ old('other_expenses') }}"></div></div>
                <div class="col-md-4"><label class="form-label">Distribuições anteriores</label><div class="input-group"><span class="input-group-text">R$</span><input class="form-control" name="prior_distributions" value="{{ old('prior_distributions') }}"></div></div>
                <div class="col-md-4"><label class="form-label">Pró-labore mensal</label><div class="input-group"><span class="input-group-text">R$</span><input class="form-control" name="monthly_pro_labore" value="{{ old('monthly_pro_labore') }}" placeholder="Ex.: 3.500,00"></div></div>
                <div class="col-md-4"><label class="form-label">Crescimento mensal</label><div class="input-group"><input class="form-control" name="monthly_growth_rate" value="{{ old('monthly_growth_rate') }}"><span class="input-group-text">%</span></div></div>
                <div class="col-md-4"><label class="form-label">Meses de planejamento</label><input class="form-control" type="number" name="planning_months" min="1" max="24" value="{{ old('planning_months') }}" placeholder="Ex.: 6"></div>
            </div>
        </x-tools.form-panel>
        @endif
