...
final class ToolManifestTest extends TestCase
{
    public function test_manifest_has_expected_identity_and_tiers(): void
    {
        ...
        self::assertSame('simulador-distribuicao-lucros-balanco', $manifest->slug);
        self::assertSame('tools.simulador-distribuicao-lucros-balanco.index', $manifest->routeName);
