...
{
    #[CoversPlusFeature('calculadora-pro-labore-distribuicao-lucros', 'history_exports')]
    #[CoversPlusFeature('calculadora-pro-labore-distribuicao-lucros', 'scenario_planning')]
    public function test_plus_features_block_free_and_allow_plus_in_monetized_mode(): void
    {
        $features = ['scenario_planning', 'history_exports'];
