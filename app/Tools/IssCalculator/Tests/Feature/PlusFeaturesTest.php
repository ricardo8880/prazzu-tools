...
{
    #[CoversPlusFeature('calculadora-iss', 'monthly_consolidation')]
    public function test_plus_features_block_free_and_allow_plus_in_monetized_mode(): void
    {
        $manifest = (new Tool)->manifest();
        foreach (['retention', 'multiple_services', 'municipality_scenarios', 'monthly_consolidation', 'export'] as $feature) {
