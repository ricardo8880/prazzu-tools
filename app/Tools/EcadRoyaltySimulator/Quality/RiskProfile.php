...
namespace App\Tools\EcadRoyaltySimulator\Quality;
...
final class RiskProfile
{
    ...
    {
        return new ToolRiskProfile(toolSlug: 'simulador-ecad-direitos-autorais', nature: ToolNature::Calculation, normativeDependency: NormativeDependency::High, personalDataExposure: PersonalDataExposure::None, externalIntegrationDependency: ExternalIntegrationDependency::None, persistenceMode: PersistenceMode::Temporary, processingMode: ProcessingMode::Synchronous, resultRisk: ResultRisk::Financial, updateFrequency: UpdateFrequency::Annual, exportFormats: []);
    }
}
