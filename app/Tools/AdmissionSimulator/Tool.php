...
namespace App\Tools\AdmissionSimulator;
...
final class Tool implements HasAnalyticsJourney, HasHistoryPolicy, HasToolIntegrations, HasViews, HasWebRoutes, ToolModule
{
    ...
    public function analyticsJourney(): ToolAnalyticsJourney
    {
        return new ToolAnalyticsJourney(
            toolSlug: 'simulador-admissao',
            forms: [
                new ToolAnalyticsForm(
                    key: 'main',
                    steps: ['input'],
                    fields: [
                    new ToolAnalyticsField('monthly_burden', 'input', selector: '[name="monthly_burden"]'),
                    ],
    ...
    public function manifest(): ToolManifest
    {
        return new ToolManifest(
            ...
            name: 'Simulador de Admissão',
            description: 'Calcule custos de contratação e gere checklist admissional.',
            category: ToolCategory::Labor,
            icon: 'bi-person-plus',
            routeName: 'tools.simulador-admissao.index',
            ...
            keywords: ['admissão', 'contratação', 'custo admissional', 'checklist admissional', 'documentos trabalhistas'],
            capabilities: [
    ...
    {
        return new ToolHistoryPolicy(enabled: true, retentionDays: 365, inputFields: ['salary', 'benefits', 'monthly_burden', 'exam', 'recruitment', 'equipment', 'training'], resultFields: ['first_month', 'recurring', 'one_off', 'annual'], sensitiveFields: []);
    }
    ...
    {
        return 'tools-simulador-admissao';
    }
}
