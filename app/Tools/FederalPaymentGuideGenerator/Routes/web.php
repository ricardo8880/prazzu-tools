...
Route::prefix('ferramentas/gerador-darf-gps')->name('tools.gerador-darf-gps.')->group(function (): void {
    ...
    Route::post('/exportar/{format}', [ToolController::class, 'exportCurrent'])->whereIn('format', ['csv', 'json', 'pdf', 'xlsx'])->middleware('tool.feature:gerador-darf-gps,professional_export')->name('export');
