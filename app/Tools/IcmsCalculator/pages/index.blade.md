# Calculadora de ICMS Próprio

## Objetivo

Calcula ICMS próprio de forma paramétrica, separado de ST, DIFAL e FCP.
...
- View: `app/Tools/IcmsCalculator/Resources/views/index.blade.php`
- Controller: `app/Tools/IcmsCalculator/Presentation/Controllers/ToolController.php`
- Domínio: `app/Tools/IcmsCalculator/Domain/Services/Calculator.php`
...
O recurso `inside_calculation` amplia o diagnóstico sem esconder a solução Essencial.
