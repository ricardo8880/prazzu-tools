        ...
        $validator->after(function (Validator $validator): void {
            ...
            try {
                ...
                foreach ((array)$this->input('operations',[]) as $operation) {
                    ...
                    if ($value !== '') $total = $total->add(Money::fromDecimal($value));
                }
                if ($total->minorAmount() <= 0) $validator->errors()->add('taxable_revenue','Informe uma base tributável maior que zero.');
            } catch (Throwable) {}
        });
    }
