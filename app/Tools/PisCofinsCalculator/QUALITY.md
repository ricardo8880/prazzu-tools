# Qualidade da Calculadora PIS e COFINS
...
O perfil executável está em `Quality/RiskProfile.php`. Perfil revisado para cálculo tributário federal com dependência normativa alta.

## Casos dourados

Os casos dourados foram preenchidos com cenários típico, fronteira, inválido, arredondamento, não aplicável, transição normativa e regressão.
...
- [x] Nenhum dado pessoal é enviado para analytics.
...
- [x] Todos os contratos declarados estão registrados no Core.
- [x] A ferramenta funciona normalmente sem integração.
...
- [x] Casos dourados completos e aprovados.
- [x] Fontes normativas registradas quando aplicável.
