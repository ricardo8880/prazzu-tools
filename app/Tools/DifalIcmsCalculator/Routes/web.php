...
Route::get('/ferramentas/calculadora-difal-icms/exportar/{format}', [ToolController::class, 'exportCurrent'])->whereIn('format', ['pdf', 'xlsx'])->middleware('tool.feature:calculadora-difal-icms,export')->name('tools.calculadora-difal-icms.export');
