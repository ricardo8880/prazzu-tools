...
Route::get('/ferramentas/calculadora-difal-icms/exportar/{format}',[ToolController::class,'exportCurrent'])->whereIn('format',['pdf','xlsx'])->name('tools.calculadora-difal-icms.export');
