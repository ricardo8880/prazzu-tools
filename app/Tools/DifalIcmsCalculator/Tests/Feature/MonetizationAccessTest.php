...
{
    #[CoversPlusFeature('calculadora-difal-icms', 'double_base')]
    #[CoversPlusFeature('calculadora-difal-icms', 'export')]
    #[CoversPlusFeature('calculadora-difal-icms', 'fcp')]
    #[CoversPlusFeature('calculadora-difal-icms', 'interstate_assist')]
    public function test_lot_six_features_block_free_and_allow_plus_in_monetized_mode(): void
    {
        $manifest = (new Tool)->manifest();
        $this->assertFeatureAccess($manifest, 'interstate_assist');
        $this->assertFeatureAccess($manifest, 'double_base');
        $this->assertFeatureAccess($manifest, 'fcp');
