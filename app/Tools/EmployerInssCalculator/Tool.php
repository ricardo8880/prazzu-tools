...
namespace App\Tools\EmployerInssCalculator;
...
final class Tool implements HasAnalyticsJourney, HasHistoryPolicy, HasToolIntegrations, HasViews, HasWebRoutes, ToolModule
{
        ...
        return new ToolAnalyticsJourney(
            ...
            forms: [
                new ToolAnalyticsForm(
                    ...
                    steps: ['input'],
                    fields: [
                        new ToolAnalyticsField('payroll', 'input', selector: '[name="payroll"]'),
                        new ToolAnalyticsField('regime', 'input', selector: '[name="regime"]'),
                        new ToolAnalyticsField('adjusted_rat', 'input', selector: '[name="adjusted_rat"]'),
    ...
    public function manifest(): ToolManifest
    {
        return new ToolManifest(
            slug: 'inss-patronal',
            name: 'Calculadora de INSS Patronal',
            description: 'Calcule CPP, RAT ajustado e terceiros conforme o enquadramento da empresa.',
            category: ToolCategory::Labor,
            icon: 'bi-building-check',
            routeName: 'tools.inss-patronal.index',
            ...
            keywords: ['inss patronal', 'cpp', 'rat', 'fap', 'terceiros', 'folha de pagamento'],
            capabilities: [
    ...
    {
        return new ToolHistoryPolicy(enabled: true, retentionDays: 365, inputFields: ['payroll', 'regime', 'adjusted_rat', 'third_parties'], resultFields: ['total', 'cpp', 'rat', 'third_parties'], sensitiveFields: []);
    }
