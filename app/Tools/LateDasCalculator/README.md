...
Atualiza o DAS com multa diária, juros informados e memória.
...
Cálculo em lote, relatórios, histórico e exportações. Esses recursos representam produtividade e continuidade; não alteram a
correção do resultado Essencial.

## Regras

Entradas principais: Principal, vencimento, pagamento e Selic acumulada oficial. O resultado é orientativo e casos normativos,
