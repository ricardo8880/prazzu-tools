...
namespace App\Tools\WorkIncomeStatementGenerator\Tests\Fixtures;
        ...
        return new GoldenCaseSuite(
            ...
            cases: [
                new GoldenCase(
                    ...
                    reference: 'CalculatorTest do módulo e memória de cálculo da versão 1.1.0.',
                    normativeRuleVersion: '1.1.0',
                ...
                new GoldenCase(
                    ...
                    reference: 'Regras de validação e CalculatorTest do módulo na versão 1.1.0.',
                    normativeRuleVersion: '1.1.0',
                    roundingPolicy: 'Valores monetários em centavos, sem float.',
                ),
                new GoldenCase(
                    ...
                    reference: 'FormRequest e invariantes do domínio do módulo na versão 1.1.0.',
                    normativeRuleVersion: '1.1.0',
                ),
                new GoldenCase(
                    identifier: 'rounding',
                    ...
                    reference: 'Política Money do Core e CalculatorTest do módulo na versão 1.1.0.',
                    normativeRuleVersion: '1.1.0',
                    roundingPolicy: 'Valores monetários em centavos, sem float.',
                ),
                new GoldenCase(
                    ...
                    reference: 'Invariantes e avisos do domínio do módulo na versão 1.1.0.',
                    normativeRuleVersion: '1.1.0',
                ),
                new GoldenCase(
                    ...
                    reference: 'Memória de cálculo e metadados normativos do módulo na versão 1.1.0.',
                    normativeRuleVersion: '1.1.0',
                ),
                new GoldenCase(
                    ...
                    reference: 'CalculatorTest do módulo aprovado para a versão 1.1.0.',
                    normativeRuleVersion: '1.1.0',
                    roundingPolicy: 'Valores monetários em centavos, sem float.',
                ),
            ],
