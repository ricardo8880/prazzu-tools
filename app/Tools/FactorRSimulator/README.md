...
Calcula FS12 ÷ RBT12, anexo aplicável e diferença de folha até 28%.
...
Cenários mensais e anuais, projeções, histórico e alertas. Esses recursos representam produtividade e continuidade; não alteram a
correção do resultado Essencial.

## Regras

Entradas principais: FS12 e RBT12, incluindo as regras especiais para acumulados zerados. O resultado é orientativo e casos normativos,
