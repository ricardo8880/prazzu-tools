...
namespace App\Tools\RetroactiveDasRegularizationCalculator\Quality;
...
final class RiskProfile
{
    ...
    {
        return new ToolRiskProfile(toolSlug:'calculadora-das-retroativo-regularizacao-simples', nature:ToolNature::Calculation, normativeDependency:NormativeDependency::High, personalDataExposure:PersonalDataExposure::None, externalIntegrationDependency:ExternalIntegrationDependency::None, persistenceMode:PersistenceMode::Temporary, processingMode:ProcessingMode::Synchronous, resultRisk:ResultRisk::Financial, updateFrequency:UpdateFrequency::Monthly, exportFormats:['pdf','xlsx']);
    }
}
