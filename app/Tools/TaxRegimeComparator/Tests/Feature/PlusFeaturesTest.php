...
{
    #[CoversPlusFeature('comparador-tributario', 'annual_projection')]
    #[CoversPlusFeature('comparador-tributario', 'multiple_scenarios')]
    public function test_lot_five_features_block_free_and_allow_plus_in_monetized_mode(): void
    {
        $manifest = (new Tool)->manifest();
        $this->assertFeatureAccess($manifest, 'multiple_scenarios');
