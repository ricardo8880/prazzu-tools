    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator): void {
            if ($this->input('operation_type') === 'interstate') {
                if ($this->input('origin_uf') === $this->input('destination_uf')) {
                    $validator->errors()->add('destination_uf', 'Em operação interestadual, origem e destino devem ser diferentes.');
                }
                if ($this->input('interstate_rate') === null || $this->input('interstate_rate') === '') {
                    $validator->errors()->add('interstate_rate', 'Informe a alíquota interestadual da operação.');
                }
            }
        });
    }
