...
namespace App\Tools\IcmsStCalculator\Quality;
...
final class RiskProfile
{
    ...
    {
        return new ToolRiskProfile(toolSlug:'calculadora-icms-st',nature:ToolNature::Calculation,normativeDependency:NormativeDependency::High,personalDataExposure:PersonalDataExposure::None,externalIntegrationDependency:ExternalIntegrationDependency::None,persistenceMode:PersistenceMode::History,processingMode:ProcessingMode::Synchronous,resultRisk:ResultRisk::Tax,updateFrequency:UpdateFrequency::Unpredictable,exportFormats:['pdf','xlsx']);
    }
}
