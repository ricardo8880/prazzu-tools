...
Route::get('/ferramentas/calculadora-retencoes-nota-fiscal/export/{format}',[ToolController::class,'exportCurrent'])->whereIn('format',['pdf','xlsx'])->name('tools.calculadora-retencoes-nota-fiscal.export');
