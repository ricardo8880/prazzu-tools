...
Route::prefix('admin/blog')->name('admin.blog.')->middleware('internal.admin')->group(function (): void {
    Route::get('/analytics', AdminBlogAnalyticsController::class)->name('analytics');
...
Route::post('/blog/analytics', [BlogAnalyticsController::class, 'store'])->middleware('throttle:120,1')->name('blog.analytics');
